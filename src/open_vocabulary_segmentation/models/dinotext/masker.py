...
# Talk2DINO
# ------------------------------------------------------------------------------
"""Mask generation utilities that turn similarity scores into segmentation masks."""
...
from src.open_vocabulary_segmentation.models.dinotext.modules import FeatureEncoder

from src.open_vocabulary_segmentation.utils import get_logger
